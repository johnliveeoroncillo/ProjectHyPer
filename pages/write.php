...
<div class="w-full h-full relative flex flex-row overflow-hidden">
    <div class="flex-1 flex flex-col overflow-hidden">
        <div class="flex-1 w-full h-full">
            ...
            <textarea class="resize-none p-8 bg-transparent w-full h-full" placeholder="Enter or paste your text here ..." id="write-area">how do yoy sea ?</textarea>
        </div>
    ...
    <div class="border-l w-[40vw] relative overflow-hidden">
