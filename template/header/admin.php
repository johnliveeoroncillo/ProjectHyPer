<div class="bg-blue-700 bg-opacity-60 p-4 top-0 w-full left-0 px-10 z-10 h-[200px] lg:h-[155px] flex flex-row justify-between items-center">
    ...
    <div class="flex-1 text-lg lg:text-2xl text-center text-white mt-0 flex lg:block flex-col lg:flex-row ">
        <a href="admin/users-list" class="text-center w-full rounded-lg py-4 px-10 font-semibold text-white hover:bg-gray-200 hover:text-gray-900">Users List</a>
        <a href="admin/history" class="text-center w-full rounded-lg py-4 px-10 font-semibold text-white hover:bg-gray-200 hover:text-gray-900">History</a>
        <a href="admin/settings" class="text-center w-full rounded-lg py-4 px-10 font-semibold text-white hover:bg-gray-200 hover:text-gray-900">Settings</a>
